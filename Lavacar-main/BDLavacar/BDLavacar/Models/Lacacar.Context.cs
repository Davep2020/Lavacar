...
public partial class bdlavacarEntities1 : DbContext
{
    ...
    public virtual int sp_InsertarPersona(string cedula, string genero, string fecha, string nombre, string correo, Nullable<int> idProvincia, Nullable<int> idCanton, Nullable<int> idDistrito, Nullable<int> tipo)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_InsertarPersona", cedulaParameter, generoParameter, fechaParameter, nombreParameter, correoParameter, idProvinciaParameter, idCantonParameter, idDistritoParameter, tipoParameter);
    }
